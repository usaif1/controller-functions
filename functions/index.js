...
flespiClient.socket.on("reconnect", () => {
  logger.warn("trying to reconnect");
});
flespiClient.socket.on("close", () => {
  logger.warn("connection closes");
});
flespiClient.socket.on("offline", () => {
  logger.warn("connection offline");
});
flespiClient.socket.on("error", () => {
  logger.error("connection error");
});
flespiClient.socket.on("connect", () => {
